            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">User verification
                        <a class="btn btn-primary float-end" href="{{ route('admin.index') }}">List of user</a>
                    </div>
                    <div class="card-body">
                        <div class="row my-2">
                        ...
                        <div class="row my-2">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="scanResultsByDecodedText" class="form-label">Scan Results (Decoded
                                        Text)</label>
                                    <textarea class="form-control" readonly id="scanResultsByDecodedText" cols="30" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row my-2">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" readonly id="scanResultsByDecodedResult" cols="30" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
