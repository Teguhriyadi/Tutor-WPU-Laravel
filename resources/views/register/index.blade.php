    ...
    <div class="col-lg-5">
        <main class="form-registration">
            ...
            <form action="{{ url('/register') }}" method="POST">
                ...
                <div class="form-floating">
                    <input type="text" name="username" class="form-control @error('username') is-invalid @enderror " id="username" placeholder="Username" id="username" required value="{{ old('username') }}">
